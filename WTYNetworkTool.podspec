...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of WTYNetworkTool.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/litengyue117@163.com/WTYNetworkTool'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'litengyue117@163.com' => 'litengyue117@163.com' }
  s.source           = { :git => 'https://github.com/litengyue117@163.com/WTYNetworkTool.git', :tag => s.version.to_s }
